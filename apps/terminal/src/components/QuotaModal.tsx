      ...
      <div className="relative w-full max-w-md bg-[#0a0a18] border border-cyan-500/30 rounded-2xl p-8 shadow-[0_0_50px_rgba(6,182,212,0.15)]">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center mb-6 border border-cyan-500/40">
            <ZapIcon className="text-cyan-400 w-8 h-8 animate-pulse" />
          </div>
          ...
          <p className="text-gray-400 text-sm mb-8 leading-relaxed">
            Your institutional-grade reasoning limit has been reached for today. Upgrade to{' '}
            <span className="text-cyan-400 font-bold">VIP Dedicated Infrastructure</span> for
            unlimited access and gRPC performance.
          </p>

          <div className="w-full space-y-3 mb-8">
            <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/5">
              <ShieldCheckIcon className="text-cyan-400 w-5 h-5 shrink-0" />
              <p className="text-gray-300 text-xs text-left">Unlimited AI Narratives & Scoring</p>
            </div>
            <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/5">
              <ZapIcon className="text-cyan-400 w-5 h-5 shrink-0" />
              <p className="text-gray-300 text-xs text-left">
                Dedicated gRPC Endpoints (0ms Latency)
              </p>
            </div>
          </div>
