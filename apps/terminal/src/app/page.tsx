    ...
    <main className="min-h-screen bg-[#050510] text-gray-100 selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl w-full text-center z-10">
          ...
          >
            Real-time L2 reasoning, direct Jito liquidity bundles, and institutional-grade mempool
            scouting for the modern Solana professional.
          </motion.p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-md">
              ...
              <p className="text-zinc-500 font-medium">
                A fraction of the RZUNA intelligence pipeline. Secure institutional access to
                decrypt full narratives.
              </p>
            </div>
      ...
      <section className="py-32 px-6">
        <div className="text-center mb-20">
          <h2 className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.4em] mb-4 text-center">
            Platform Pillars
          </h2>
          <h3 className="text-4xl font-bold tracking-tight text-white uppercase">
      ...
      <section id="pricing" className="py-32 px-6 bg-[#03030a]">
        <div className="text-center mb-20">
          <h2 className="text-cyan-500 text-[10px] font-black uppercase tracking-[0.4em] mb-4 text-center">
            Pricing Strategy
          </h2>
          <h3 className="text-4xl font-bold tracking-tight text-white uppercase">
      ...
      <footer className="py-20 border-t border-white/5 text-center">
        <h4 className="text-zinc-700 text-[10px] font-black uppercase tracking-[0.5em] mb-6">
          AIVO.SH // RZUNA V1.6
        </h4>
